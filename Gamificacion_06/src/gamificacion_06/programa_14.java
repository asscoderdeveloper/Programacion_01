...
visualiza todas aquellas palabras que terminen en “ion” */
...
public class programa_14 {
    ...
    public static void main (String [] args)throws Exception{
        //metodo principal
        new programa_14().metodoPrincipal();
    }
    public void metodoPrincipal(){
        ...
        System.out.println("El numero de palabras acabadas en ion es: " + contador);
